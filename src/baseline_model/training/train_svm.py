...
Baseline Support Vector Machine classifier for Carnatic raga identification.
...
Workflow:
    ...
    4. Train SVC(kernel="rbf", C=1.0, gamma="scale")
...
def train_svm(
    ...
    # 1. Load dataset
    # ------------------------------------------------------------------
    print("[train_svm] Loading dataset …")
    X, y, ids, splits, class_names = load_dataset(training_matrix)
    print(f"[train_svm] X shape      : {X.shape}")
    print(f"[train_svm] Classes      : {list(class_names)}")
    ...
    # ------------------------------------------------------------------
    print("[train_svm] Fitting StandardScaler on training split …")
    ...
    # 4. Train
    # ------------------------------------------------------------------
    print('[train_svm] Training SVC(kernel="rbf", C=1.0, gamma="scale") …')
    ...
    # ------------------------------------------------------------------
    print("\n[train_svm] ── Validation Evaluation ──")
    ...
    print(f"[train_svm] Validation accuracy : {val_acc:.4f}")

    # ------------------------------------------------------------------
    # 6. Evaluate – test split
    # ------------------------------------------------------------------
    print("\n[train_svm] ── Test Evaluation ──")
    ...
    print(f"[train_svm] Test accuracy       : {test_acc:.4f}")

    # ------------------------------------------------------------------
    # 7. Save model
    # ------------------------------------------------------------------
    save_model(model, model_path)
    print(f"[train_svm] Model saved → {model_path}")
